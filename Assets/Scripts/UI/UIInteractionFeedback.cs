...
public class UIInteractionFeedback : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    private void Update()
    {
        // 使用 Lerp 进行平滑的阻尼运动，视觉表现极佳
        targetVisual.localScale = Vector3.Lerp(targetVisual.localScale, currentTargetScale, Time.deltaTime * smoothSpeed);
        targetVisual.anchoredPosition = Vector2.Lerp(targetVisual.anchoredPosition, currentTargetPosition, Time.deltaTime * smoothSpeed);
    }
